...
// NORMALLY PUT THUNKS HERE, BUT WE ARE NOT MAKING AN API CALL SO NO NEED FOR THUNKS;

// REDUCER FUNCTION:
// Part of the reason why we have to return a default value for our switch statement is because combineReducers will go into our object of reducers and invoke all reducer function to address the incoming action object --- witout a default statement, we would return undefined --- which would replace the state of that value to be undefined;
